...
import com.jn.search.repostory.SearchRepository;
import com.jn.search.pojo.SkuInfo;
import com.jn.search.service.SearchManagerService;
import com.jn.search.service.SkuService;
...
//            System.out.println("==================执行创建");
            ...
            template.indexOps(SkuInfo.class).createMapping(SkuInfo.class);
//        }
    }
    ...
    public void importAll() {
        //1.查询全部的sku列表数据
        Page<Sku> page = skuService.findPage(1, 1000);
