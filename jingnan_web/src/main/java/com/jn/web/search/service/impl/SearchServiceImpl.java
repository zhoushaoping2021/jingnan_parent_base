...
import com.jn.web.search.service.SearchService;
...
public class SearchServiceImpl implements SearchService {
    ...
    public Map<String, Object> search(Map<String, String> paramMap) {
        ...
        //执行查询
        SearchHits<SkuInfo> searchHits = esTemplate.search(query, SkuInfo.class, IndexCoordinates.of("jshop_product"));
        //解析查询结果
     ...
     * @return
     */
    private Map<String, Object> parseResponse(SearchHits<SkuInfo> searchHits) {
        ...
        for (SearchHit<SkuInfo> hit : searchHits.getSearchHits()) {
            //将json转换成对象
